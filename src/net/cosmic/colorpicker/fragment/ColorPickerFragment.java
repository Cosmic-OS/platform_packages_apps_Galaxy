...
package net.cosmic.colorpicker.fragment;
...
import net.cosmic.colorpicker.widget.ApplyColorView;
import net.cosmic.colorpicker.widget.ColorPickerView;
import net.cosmic.colorpicker.widget.ColorViewButton;
import net.cosmic.colorpicker.util.ColorPickerHelper;
...
public class ColorPickerFragment extends Fragment implements
    ...
    private static final int PALETTE_COSMIC  = 0;
    ...
    private void setUpPaletteColorButtons() {
        ...
        TypedArray colors = mResources.obtainTypedArray(R.array.color_picker_cosmic_palette);
        ...
        for (int i=0; i<3; i++) {
            ...
            int titleResId = R.string.palette_cosmic_title;
